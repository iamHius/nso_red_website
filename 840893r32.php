...
<?php include('error.php'); ?>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["search"])) {
            ...
            $search_query = "SELECT id FROM player WHERE username = '$search_username'";
            ...
            if ($search_result && mysqli_num_rows($search_result) > 0) {
                ...
                $info_query = "SELECT u.username, u.luong, u.ninja, u.vip, u.coin FROM player u JOIN ninja p WHERE p.id = '$search_username'";
                ...
                if ($info_result) {
                  ...
                  if ($info_row) {
                      echo "<table>";
                    echo "<tr><td>Tên nhân vật:</td><td>" . $info_row["ninja"] . "ninja</td></tr>";
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
          if (checkAdmin($conn, $_SESSION['username'])) {
            ...
            if ($currency == 'luong' || $currency == 'coin' || $currency == 'nap'|| $currency == 'vip' || $currency == 'XacThuc') {
                $update_query = "UPDATE player SET $currency = $currency + $amount WHERE id = $user_id";
            } else {
                $update_query = "UPDATE ninja SET $currency = $currency + $amount WHERE id = $user_id";
            }
