    ...
    <form method="POST" class="form-signin" action="">
        ...
        <div class="text-center mt-3">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "SELECT ninja.id, ninja.name, player.username, player.password, player.XacThuc, player.role, ninja.xu, ninja.yen, player.coin, player.luong, ninja.isVIP, player.nap
                    FROM ninja
                    JOIN player ON ninja.id = player.id
                    WHERE ninja.name = '$searchTerm'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    <table class='table'>
                        <tbody>
                            ...
                            <tr class='fw-semibold'>
                                <td>Tình trạng</td>
                                <td>" . getStatusDescription($row["XacThuc"]) . "</td>
                            </tr>
                            <tr class='separator'></tr>
                            <tr class='fw-semibold'>
                                <td>Trạng thái</td>
                                <td>" . getActivatedDescription($row["XacThuc"]) . "</td>
                            </tr>
                            <tr class='separator'></tr>
