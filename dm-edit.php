    ...
    <div class="card-body">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (isset($_POST["edit"])) {
                ...
                $sqlSelectCurrentData = "SELECT * FROM news_ports WHERE id = $news_portsId";
                ...
                if ($resultCurrentData->num_rows > 0) {
                    ...
                    if (!empty($updateData)) {
                        ...
                        $sqlUpdate = "UPDATE news_ports SET ";
                ...
                $sqlDelete = "DELETE FROM news_ports WHERE id = $news_portsId";
       ...
       /* // Kiểm tra kết nối cơ sở dữ liệu
        ...
        $sqlSelect = "SELECT * FROM news_ports";
