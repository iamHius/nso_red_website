...
if (isset($_POST["submit"])) {
    ...
    if ($old_phone == "") {
        ...
        $kiem_tra_so_dien_thoai_sql = "SELECT * FROM `player` WHERE `username` = '" . $_SESSION['username'] . "' AND `phone` = '$old_phone'";
        ...
        if (mysqli_num_rows($kiem_tra_so_dien_thoai_query) > 0) {
            ...
            $cap_nhat_so_dien_thoai_sql = "UPDATE `player` SET `phone` = '$new_phone' WHERE `username` = '" . $_SESSION['username'] . "'";
