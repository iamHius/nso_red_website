...
<?php include('error.php'); ?>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["search"])) {
                ...
                $sqlSelect = "SELECT * FROM ninja WHERE name = '$searchName'";
            ...
            if (isset($_POST["edit"])) {
                ...
                $sqlSelectOld = "SELECT * FROM ninja WHERE id = $playersId";
                ...
                if (!empty($newValues)) {
                    ...
                    if (isset($newValues['name'])) {
                        ...
                        $checkDuplicateName = "SELECT id FROM ninja WHERE name = '$newName' AND id != $playersId";
                    ...
                    $sqlUpdate = "UPDATE ninja SET $setClause WHERE id = $playersId";
